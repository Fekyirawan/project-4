...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
       <a href="{{ url('/beranda') }}" class="logo"><b>ADMIN</b></a>
      <!--logo end-->
        ...
        <ul class="nav top-menu">
          ...
          <li id="header_inbox_bar ">
            ...
            <ul class="dropdown-menu extended inbox pull-right">
              ...
              <li>
              <form class="navbar-form" action="{{url('login')}}">
                <button type="submit" class="btn btn-"> Login </button>
              </form>
              </li>
              <li>
                 <form class="navbar-form" action="{{url('login')}}">
                      <button type="submit" class="btn btn-">Registrasi</button>
                 </form>
              </li>
            </ul>
          </li>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub">
            <a class="javascript:;" href="{{url('/produk')}}">
              <i class="fa fa-th"></i>
              <span>Produk</span>
              </a>
          </li>
           <li class="sub">
            <a class="javascript:;" href="{{url('/kategori')}}">
              <i class="fa fa-th"></i>
              <span>Kategori</span>
              </a>
          </li>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
         ...
         <h1>Welcome {{Auth::user()->nama}}</h1> <hr><br>
         <h1></h1>
